...
namespace Yarn.Unity
{
    ...
    public class DialogueRunner : MonoBehaviour, ILineLocalisationProvider
    {
        ...
        public static bool GetIsDialogueRunning ()
        {
            if (instance == null)
                return false;
            return instance.IsDialogueRunning;
        }
        /// <summary>
        ...
        public static void StartDialogue(string startNode)
        {
            ...
            instance.dialogueUI.StopAllCoroutines();
            ...
            void RunDialogue()
            {
                ...
                instance.IsDialogueRunning = true;

                // Signal that we're starting up.
                instance.dialogueUI.DialogueStarted();

                instance.Dialogue.SetNode(startNode);

                instance.ContinueDialogue();
            }
        }
        ...
        public static void DoAddCommandHandler(string command_name, BlockingCommandHandler handler)
        {
            if(instance != null)
                instance.AddCommandHandler(command_name, handler);
        }
        ...
        void Start()
        {
            ...
            if (yarnScripts != null && yarnScripts.Length > 0) {
                ...
                if (compiledPrograms == null || compiledPrograms.Count <= 0)
                    return;
